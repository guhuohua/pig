...
public class SysGoodsAreaProvider {
    ...
    public String getList(Map<String, Object> map) {
        ...
        StringBuffer sb = new StringBuffer("select g.id, g.sn, g.title, ga.goods_classification as recommend, ga.status, ga.id as goodsAreaId from goods g left join goods_area ga on g.id = ga.goods_id and g.shop_id = ga.shop_id where 1 = 1");
