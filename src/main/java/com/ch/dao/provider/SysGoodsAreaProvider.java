...
public class SysGoodsAreaProvider {
    ...
    public String getList(Map<String, Object> map) {
        ...
        StringBuffer sb = new StringBuffer("select ga.id, g.id as goodsId, g.sn, g.title, ga.goods_classification as recommend, ga.status, ga.id as goodsAreaId, ga.sort from goods_area ga left join goods g on g.id = ga.goods_id where 1 = 1");
